      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="space-y-2">
          {faqData.map((faq, index) => (
            <div key={index} className="hover:bg-gray-700 transition-colors" style={{ backgroundColor: 'rgb(45, 45, 45)' }}>
              <button
        ...
        <div className="text-center mt-12">
          ...
          <form onSubmit={handleGetStarted} className="flex flex-col sm:flex-row gap-2 max-w-md mx-auto">
            <input
              ...
              className="flex-1 px-4 py-3 bg-zinc-800/70 border border-gray-600 rounded text-white placeholder-gray-400 focus:outline-none focus:border-white"
              required
            />
            <button
              type="submit"
