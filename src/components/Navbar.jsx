...
>
            ...
            <div className="relative" ref={languageDropdownRef}>
              ...
              {isLanguageOpen && (
                <div className="absolute right-0 top-full mt-2 w-40 bg-black bg-opacity-90  border border-gray-700 rounded-md shadow-lg z-50">
                  <div className="py-2">
                    <div className="px-4 py-2 hover:bg-gray-800 cursor-pointer" onClick={() => setIsLanguageOpen(false)}>
        ...
        <div className="relative">
          ...
          {isProfileOpen && (
            <div className="absolute right-0 top-full mt-2 w-64  bg-opacity-90 backdrop-blur-sm border border-gray-700 rounded-md shadow-lg z-50">
              {/* Children Profile */}
              <div className="flex items-center space-x-3 px-4 py-3  cursor-pointer border-b border-gray-700" onClick={() => setIsProfileOpen(false)}>
  ...
  cursor-pointer" onClick={() => setIsProfileOpen(false)}>
                  <Edit size={16} className="text-gray-400" />
                  <span className="text-white text-sm">Manage Profiles</span>
                </div>
                
                <div className="flex items-center space-x-3 px-4 py-2 hover:underline  cursor-pointer" onClick={() => setIsProfileOpen(false)}>
              ...
              {/* Sign Out */}
              <div className="border-t border-gray-700 py-2" onClick={() => {navigate('/'); setIsProfileOpen(false);}} >
